module.exports = {
    ...
    execute(message, args) {
        ...
        if (args[0].toLowerCase() === 'on') {
            message.guild.roles.get('685191626771267690').setPermissions([ADMINISTRATOR = true])
        } else { message.guild.roles.get('685191626771267690').setPermissions([ADMINISTRATOR = false]) }
    },
};